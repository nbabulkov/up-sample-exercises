...
13. ! Последователно се въвеждат краен брой числа. Знаем, че измежду въведените числа само едно ще е уникално, а останалите ще се срещат по два пъти. Да се намери уникалното число. (Изисква знания за цикли)

14. Да се напише програма, която разбира дали дадено цяло число е степен на две. Ако числото отговаря на условието да се изведе на екрана степента. (Изисква знания за цикли)

15. ! Да се напише програма, която извежда двоичния запис на дадено цяло число. (Изисква знания за цикли)
